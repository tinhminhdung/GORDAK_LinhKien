...
IF NOT EXISTS(SELECT * FROM sys.columns WHERE Name = N'Accessories' AND Object_ID = Object_ID(N'Products'))
BEGIN
    ALTER TABLE Products ADD Accessories NVARCHAR(500) NULL
END
GO
