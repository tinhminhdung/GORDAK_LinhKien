...
namespace Antigravity.ECommerce.Controllers
{
    ...
    public class AdminDocumentCategoryController : Controller
    {
        private const int CategoryTypeCode = 8;
        ...
        public IActionResult Create(Category model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (existingName != null)
                    ModelState.AddModelError("Name", "Tên danh mục tài liệu này đã tồn tại.");
